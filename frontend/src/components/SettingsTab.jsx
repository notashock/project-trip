  ...
  return (
    <div className="space-y-8 text-slate-700">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-[0_4px_25px_-4px_rgba(0,0,0,0.02)]">
            <div className="flex items-center gap-2 border-b border-slate-100 pb-4 mb-6">
              <div className="w-8 h-8 rounded-xl bg-emerald-50 flex items-center justify-center text-[#056449]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-800 font-medium focus:outline-none focus:border-[#056449] transition text-sm"
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-800 focus:outline-none focus:border-[#056449] transition text-sm font-medium"
                  />
      ...
      <div className="flex justify-end gap-3 mt-8">
        <button onClick={() => setActiveTab('overview')} className="px-5 py-2.5 bg-white border border-slate-200/80 hover:bg-slate-50 text-slate-600 rounded-full text-xs font-bold transition cursor-pointer">
          Cancel
        </button>
        <button onClick={handleSaveSettings} className="px-6 py-2.5 bg-[#056449] hover:bg-[#04523b] text-white rounded-full text-xs font-bold transition cursor-pointer shadow-sm">
          Save Changes
        </button>
      </div>
    </div>
