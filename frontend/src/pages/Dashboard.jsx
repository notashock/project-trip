    ...
    <div className="min-h-screen bg-[#f8faf9] text-slate-800 font-sans pb-16">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 mt-6 sm:mt-12">
        ...
        <div className="mb-6 sm:mb-10">
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">My Trips</h1>
          <p className="text-xs sm:text-sm text-slate-450 mt-1 font-semibold">Manage your upcoming adventures and memories.</p>
        </div>
